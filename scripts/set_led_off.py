...
# switch all LEDs off
msg = binascii.unhexlify('04a001020102a50107000808001010001818003030004040008080114040000000030200a509020a010000000000000000000000000000000000000000000000')   

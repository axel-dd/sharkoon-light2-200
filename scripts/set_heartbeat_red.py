...
# LedMode=Heartbeat Color=Red 
msg = binascii.unhexlify('04a001020102a50107000808001010001818003030004040008080114040000000030200a508020a0100ff000000000000000000000000000000000000000000')
